...
*The W3C CSS Level 1 Specification*. The formal and official definition of CSS (level 1). Quite technical. http://www.w3.org/TR/CSS1

*Adding a Touch of Style* by Dave Raggett. An introductory tutorial to CSS by one of the original designers of HTML. http://www.w3.org/MarkUp/Guide/Style.html

*The Web Design Group’s CSS web site*. A more friendly, user-oriented description of CSS. http://htmlhelp.com/reference/css/

*The w3schools CSS Tutorial*. A tutorial-based introduction to CSS. http://www.w3schools.com/css/

*The W3C CSS Validation Service*. A syntax checker for CSS code. http://jigsaw.w3.org/css-validator/

*CSS Zen Garden*. A web site that demonstrates and evangelizes the flexibility and power of CSS beautifully. http://www.csszengarden.com/
