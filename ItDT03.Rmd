...
*The W3C HTML 4.01 Specification*. The formal and official definition of HTML. Quite technical. http://www.w3.org/TR/html401/

*Getting started with HTML* by Dave Raggett. An introductory tutorial to HTML by one of the original designers of the language. http://www.w3.org/MarkUp/Guide/

*The Web Design Group’s HTML 4 web site*. A more friendly, user-oriented description of HTML. http://htmlhelp.com/reference/html40/

*The w3schools HTML Tutorial*. A quick, basic tutorial-based introduction to HTML. http://www.w3schools.com/html/

*HTML Tidy*. A description of HTML Tidy, including links to online versions. http://www.w3.org/People/Raggett/tidy/

*The W3C Validation Service*. A more sophisticated validation service than HTML Tidy. http://validator.w3.org/
